...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: linear-gradient(135deg, #bca0dc, #845ec2);
            display: flex;
            align-items: center;
...
<body>
    <div class="payment-container">
        ...
        <h1 class="refunded-title">Payment Refunded</h1>
        <p class="refunded-message">Your payment has been successfully refunded.</p>
